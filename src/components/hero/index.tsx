      ...
      <div className="mb-12 mt-14 flex flex-col items-center justify-center text-center sm:mt-28">
        ...
        <Fade triggerOnce cascade>
          {user ? (
            ...
            <h1 className="max-w-4xl text-3xl font-bold sm:text-5xl">
              Welcome to <br />
              <span className="text-pink-600">Straymate,</span>
            </h1>
          )}

          <p className="sm-text-lg mt-5 max-w-prose text-zinc-700 sm:leading-relaxed"></p>
            ...
            {status === "loading" ? (
              ...
              <>
                <Link
                  ...
                  href={"/adopt"}
                >
                  Adopt <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
                {/* <Link
                    href="/register"
