  ...
  return (
    <>
        ...
        <MaxWidthWrapper>
          <div className="flex flex-col items-center justify-center gap-8 p-8 sm:flex-row">
            <div className="flex w-full flex-col items-center sm:w-1/2 sm:items-start">
              <h2 className="mb-4 max-w-3xl text-center text-3xl font-bold text-pink-600 sm:text-left sm:text-5xl md:text-5xl lg:text-6xl">
                A community driven{" "}
                <TypeAnimation
                  sequence={[
              ...
              <p className="text-left">
                {
                  "              Join us in our mission to save lives and make a difference in the lives of stray animals. Whether you're looking to adopt, foster, volunteer, or donate, together, we can change the lives of countless animals and create a brighter future for them."
                }
              </p>
              <div className="mt-10 flex gap-6">
                <Link href={"/team"}>
                  <Button variant={"pink"}>
                    Blog <GroupIcon className="ml-2 h-5 w-5" />{" "}
                  </Button>
                </Link>
                <Link href={"/events"}>
      ...
      <section className="bg-white text-black transition-colors duration-500 dark:bg-gray-900/10 dark:text-white">
        <MaxWidthWrapper>
          <h1
            className={`${myFont.className} bg-gradient-to-b from-pink-600 to-violet-400 bg-clip-text pb-4 pt-20 text-center text-6xl font-black text-transparent`}
          >
            Highlights
          </h1>
          <p className=" sm-text-l pb-5 text-center font-semibold text-zinc-700">
            We have successfully reached out many rescues.
          </p>
